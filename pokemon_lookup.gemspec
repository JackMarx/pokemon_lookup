...
Gem::Specification.new do |spec|
  spec.name          = "pokemon_lookup"
  spec.version       = PokemonLookup::VERSION
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["changelog_uri"] = "https://github.com/JackMarx/pokemon_lookup/CHANGELOG.md"
  else
  ...
  spec.add_dependency "http", "~> 4.0.2"
  # spec.add_runtime_dependency 'http', '~> 4.0', '>= 4.0.2'
end
